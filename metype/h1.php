...
<div id='metype-container' class='iframe-container' data-metype-account-id='<?php echo get_option('metype-account-id'); ?>' data-metype-host='https://staging.metype.com/' data-metype-primary-color='primary color of the widget (defaults to blue)' data-metype-bg-color='#ffffff' data-metype-font-color='#4a4a4a'></div>
